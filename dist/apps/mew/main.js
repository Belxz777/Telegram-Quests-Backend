...
__decorate([
    (0, typeorm_1.Column)({ default: 'varchar', nullable: true }),
    __metadata("design:type", String)
...
let TeamController = class TeamController {
    ...
    uploadImageUrls(name, file, nameOfLocation, result, answers) {
        console.log(...oo_oo(`760887754_34_2_34_49_4`, name, file, nameOfLocation, result));
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, typeof (_d = typeof Express !== "undefined" && (_c = Express.Multer) !== void 0 && _c.File) === "function" ? _d : Object, String, String, Array]),
...
let TeamService = class TeamService {
    ...
    async uploadImageUrls(name, file, nameOfLocation, result, answers) {
        ...
        let uploadedData = await team_controller_1.s3.Upload({
            buffer: file.buffer,
        }, '/images/');
        if (!uploadedData) {
            console.log(...oo_oo(`3123162466_36_10_36_44_4`, " no res from yandex"));
            return;
        }
        ...
        console.log(...oo_oo(`3123162466_47_6_47_26_4`, answers));
...
async function bootstrap() {
    ...
    console.log(...oo_oo(`2989447398_18_2_18_42_4`, `listening on port ${port}`));
    if (false) {}
}
bootstrap();
;
